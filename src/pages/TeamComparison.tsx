...
const TeamComparison: React.FC = () => {
  ...
  const dashboardId = 'f3c9a908-432b-4cde-9372-5abb59cbc636';
...
<html>
    <head>
        <title>Team Comparison Dashboard</title>
        <style>
            html, body {
                height: 100%;
                margin: 0;
    ...
    <body>
        ...
        <script>
            ...
            console.log('Using hardcoded dataset: customer_purple_ai');
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box sx={{ 
          ...
          <Typography variant="h6" color="text.secondary">
            Loading your team comparison dashboard...
          </Typography>
        </Box>
      </Container>
    );
    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <iframe
          ...
          title="Team Comparison Dashboard"
        />
      </Box>
    </Box>
  );
