...
const FocusPlanning: React.FC = () => {
  ...
  const dashboardId = '1dff84b8-7200-422d-9493-f99c36f9e4fb';
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box sx={{ 
          ...
          <Typography variant="h6" color="text.secondary">
            Loading your focus & planning dashboard...
          </Typography>
        </Box>
      </Container>
    );
    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <iframe
          ...
          title="Focus & Planning Dashboard"
        />
      </Box>
    </Box>
  );
